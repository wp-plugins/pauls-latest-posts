...
Pauls Latest Pots displays a list of your latest posts in the sidebar with excerpts. Excerpts length can be modified or left out completely. Useful for sites that display one post on the main page, and want to link to previous posts.

Since version 1.2, Pauls Latest Posts also shows latest comments.
...
The plugin page allows you to change the following settings: Title, Number of Posts, Excerpt Size, Post Offset, Show Comments and Number of Comments.
...
Thanks goes to Simon who suggested that I add the Latest Comments functionality. If you would like to see anything else added to the list, please do not hesitate to leave a comment on the plugin homepage.
